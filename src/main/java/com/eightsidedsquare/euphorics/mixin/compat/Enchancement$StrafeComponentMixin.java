...
public class Enchancement$StrafeComponentMixin
{
    @Inject(method = { "addStrafeParticles" }, at = { @At("HEAD") }, cancellable = true)
    private static void euphorics$cancelStrafeParticles(final Entity entity, final CallbackInfo ci) {
    ...
    private static boolean euphorics$cancelStrafeSound(final PlayerEntity instance, final SoundEvent sound, final float volume, final float pitch) {
