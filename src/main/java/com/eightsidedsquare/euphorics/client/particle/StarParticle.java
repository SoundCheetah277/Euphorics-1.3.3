...
public class StarParticle extends SpriteBillboardParticle
{
    ...
    public StarParticle(final ClientWorld clientWorld,
                        final double x,
                        final double y,
                        final double z,
    ...
    public static class RawEndustFactory implements ParticleFactory<DefaultParticleType>
    {
        ...
        public RawEndustFactory(final SpriteProvider spriteProvider) {
            this.colors = ImmutableList.of(new Vector3f(220.0f, 228.0f, 166.0f),
                    new Vector3f(199.0f, 207.0f, 136.0f),
                    new Vector3f(165.0f, 190.0f, 117.0f),
                    new Vector3f(133.0f, 172.0f, 97.0f),
                    new Vector3f(103.0f, 165.0f, 98.0f),
                    new Vector3f(96.0f, 160.0f, 92.0f),
                    new Vector3f(48.0f, 150.0f, 102.0f));
            this.spriteProvider = spriteProvider;
            this.colors.forEach(vec -> vec.div(255.0f));
        }

        @Nullable
        public Particle createParticle(final DefaultParticleType parameters,
    ...
    public static class AstralPlaneFactory implements ParticleFactory<DefaultParticleType>
    {
        ...
        public AstralPlaneFactory(final SpriteProvider spriteProvider) {
            this.colors = ImmutableList.of(new Vector3f(25.0f, 56.0f, 100.0f),
                    new Vector3f(50.0f, 62.0f, 127.0f),
                    new Vector3f(13.0f, 76.0f, 100.0f),
                    new Vector3f(43.0f, 101.0f, 147.0f),
                    new Vector3f(43.0f, 135.0f, 152.0f),
                    new Vector3f(143.0f, 75.0f, 170.0f),
                    new Vector3f(154.0f, 84.0f, 182.0f),
                    new Vector3f(163.0f, 96.0f, 175.0f),
                    new Vector3f(218.0f, 107.0f, 213.0f),
                    new Vector3f(244.0f, 140.0f, 212.0f),
                    new Vector3f(254.0f, 180.0f, 207.0f));
            this.spriteProvider = spriteProvider;
            this.colors.forEach(vec -> vec.div(255.0f));
        }
