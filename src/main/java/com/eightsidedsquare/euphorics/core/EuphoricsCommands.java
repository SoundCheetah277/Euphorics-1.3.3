...
{//TODO RETRANSLATE
    public static void init() {
        ...
        // 
        //     5: ldc             "euphorics"
        //     7: invokestatic    com/eightsidedsquare/euphorics/core/EuphoricsCommands.registerCommand:(Ljava/util/function/BiConsumer;Ljava/lang/String;)V
        //    10: return         
        // 
        ...
        //     at com.strobel.decompiler.ast.AstOptimizer$InlineLambdasOptimization.tryInlineLambda(AstOptimizer.java:3510)
    ...
    private static void registerCommand(final BiConsumer<CommandDispatcher<class_2168>, String> consumer, final String id) {
        CommandRegistrationCallback.EVENT.register(((dispatcher, registryAccess, environment) -> consumer.accept(dispatcher, id)));
    }
}
